  ...
  return (
    <main className="min-h-screen bg-stone-50">
      <header className="border-b border-stone-200 bg-white px-4 py-4">
        <div className="mx-auto max-w-4xl text-lg font-black tracking-tight">
          Fill Food
        </div>
      </header>
      ...
      <section className="bg-orange-50 px-4 py-16 text-center sm:py-20">
        <div className="mx-auto max-w-2xl">
          <p className="mb-5 text-[20px] font-black uppercase tracking-[0.4em] text-orange-500">
            Fill Food
          </p>
          ...
          <Link
            href="/role-select"
            className="mt-10 inline-flex min-w-56 justify-center rounded-xl bg-orange-500 px-8 py-4 text-base font-bold text-white shadow-sm transition-colors hover:bg-orange-600"
          >
            はじめる
          </Link>
        </div>
      ...
      <section className="border-y border-stone-200 bg-stone-100 px-4 py-6 text-center text-sm text-stone-600">
        売れなければ0円 —{" "}
        <strong className="text-stone-800">成功報酬10%</strong> /
        初期費用・月額固定費 ¥0
      </section>
    </main>
  );
