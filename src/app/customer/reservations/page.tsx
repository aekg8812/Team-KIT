...
export default function ReservationsPage() {
  ...
  return <RoleGate role="customer"><main className="min-h-screen bg-stone-50 pb-24"><header className="border-b border-stone-200 bg-white px-4 py-5"><div className="mx-auto flex max-w-2xl items-start justify-between"><div><p className="text-[10px] font-bold uppercase tracking-[0.25em] text-emerald-600">救席 — お客さま向け</p><h1 className="mt-1 text-2xl font-bold">予約履歴</h1></div><DemoRoleSwitch to="restaurant" /></div></header><div className="mx-auto max-w-2xl px-4 py-6">
